...
const u8 gText_MenuExpShare[] = _("EXP. SHARE");
...
const u8 gText_ExpSharedEnabled[] = _("EXP. SHARE enabled.\p");
const u8 gText_ExpSharedDisabled[] = _("EXP. SHARE disabled.\p");
...
const u8 gStartMenuDesc_ExpShare[] = _("Enable or disable global\n EXP. SHARE");
